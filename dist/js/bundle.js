...
function generateMountains(paper, player, store, trackConfig) {
    ...
    return function (data, event) {
        ...
        if (hits.length > 1) {
            ...
            var x = width * Math.cos(radius * i) + xPos;
            var y = height * Math.sin(radius * i) + yPos;
            var point = new paper.Point(x, y);
