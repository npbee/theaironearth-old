...
var TOGGLE_VISUALIZER = 'TOGGLE_VISUALIZER';

exports.TOGGLE_VISUALIZER = TOGGLE_VISUALIZER;

function toggleVis(isOn) {
    return {
...
var visToggle = document.getElementById('vis-toggle');
var toggleVisOn = document.getElementById('toggle-vis-on');
var toggleVisOff = document.getElementById('toggle-vis-off');
...
function bindEvents(player, dispatch, getState) {
    ...
    toggleVisOn.addEventListener('click', function (e) {
        dispatch((0, _actions.toggleVis)(true));
    });

    toggleVisOff.addEventListener('click', function (e) {
        dispatch((0, _actions.toggleVis)(false));
    });
...
exports['default'] = function (state, action) {
    ...
    switch (action.type) {
        ...
        case _actions.TOGGLE_VISUALIZER:
            return Object.assign({}, state, {
