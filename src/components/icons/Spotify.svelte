<svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 48 48">
  ...
  <g fill="currentColor">
    <path
      fill="currentColor"
      d="M24,0C10.8,0,0,10.8,0,24s10.8,24,24,24s24-10.8,24-24S37.3,0,24,0z
      M35,34.7c-0.5,0.7-1.3,1-2,0.5
      ...
      C38.2,26,38.5,27.2,37.9,28.1z
      M38.2,21.4c-7.7-4.6-20.5-5-27.8-2.8c-1.2,0.4-2.4-0.4-2.8-1.4C7.2,16,7.9,14.8,9,14.4
